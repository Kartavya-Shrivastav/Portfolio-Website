      ...
      <div ref={shellRef} className="relative z-[1] group">
        <section
          ...
          style={{
            ...
            background: `
                radial-gradient(circle at 30% 20%, rgba(120, 119, 198, 0.25), transparent 40%),
        ...
        >
          ...
          >
            ...
            >
              <div className="w-full absolute flex flex-col" style={{ top: '1.5em', display: 'flex', gridArea: 'auto' }}>
                <h3
                  className="font-semibold m-0"
                  style={{
                    fontSize: '1.8rem',   // 👈 smaller & controlled
